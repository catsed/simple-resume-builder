...
describe("convertJsonResumeDocument", () => {
    test("toJsonResumeDocument maps editor state to JSON Resume format", () => {
        ...
        expect(jsonResume.projects[0]).toEqual({
            name: "Portfolio Site",
    ...
    test("fromJsonResumeDocument maps JSON Resume to editor state", () => {
        ...
        expect(editorState.projects[0]).toMatchObject({
            name: "Portfolio Site",
            url: "https://janedoe.dev",
            startDate: "2023",
            endDate: "2024",
        ...
        expect(editorState.projects[0].id).toEqual(expect.any(String))
    })
    ...
    test("fromJsonResumeDocument creates empty starter entries when arrays are empty", () => {
        ...
        expect(editorState.projects).toHaveLength(0)
    })
})